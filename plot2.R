...
producePlot2 <- function (inputfile = "./data/household_power_consumption.txt", outputfile = "plot2.png"){
...
producePlot2(inputfile = "./data/household_power_consumption.txt", outputfile = "plot2.png")